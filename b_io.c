...
int b_read (int fd, char * buffer, int count)
	...
	printf("b_read fcbArray[fd].startingLBA: %d\n", fcbArray[fd].startingLBA);
	printf("b_read fcbArray[fd].fileBlocksAllocated: %lld\n", fcbArray[fd].fileBlocksAllocated);
	printf("b_read fcbArray[fd].fileSize : %lld\n", fcbArray[fd].fileSize);
